...
image = Image.open(r'D:\AI\imageProccessing\lether.jpg')
...
for contour in contours:  
    ...
    if area > 400:  # Increase to filter for larger signs  
        ...
        # Run Tesseract OCR  
        custom_config = r'--psm 7'  # Adjust as necessary  
        text = pytesseract.image_to_string(roi_binary, lang='fas', config=custom_config)  
